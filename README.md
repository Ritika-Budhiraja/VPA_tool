...
```
VPA/
├── app.py                           # Main VPA script (for Excel To PowerPoint.xlsm)
├── test.py                          # VPA script for test2.xlsx
├── Excel To PowerPoint.xlsm         # Default Excel file with charts
├── test2.xlsx                       # Test Excel file
├── AutoGeneratedPresentation.pptx   # Output PowerPoint (auto-created)
├── AutoGeneratedPpt.pptx           # Output PowerPoint for test2.xlsx
...
#### For Excel To PowerPoint.xlsm (Main automation):
```bash
python app.py
```

#### For test2.xlsx (Test automation):
```bash
python test.py
```
...
#### For app.py (Excel To PowerPoint.xlsm):
...
#### For test.py (test2.xlsx):
Edit these lines in `test.py`:
```python
